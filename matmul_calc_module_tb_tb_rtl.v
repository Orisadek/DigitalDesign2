//
// Test Bench Module Ori_Alon_Lab_1_lib.matmul_calc_module_tb.matmul_calc_module_tester
//
// Created:
...
wire [(MAX_DIM*MAX_DIM*2*(DATA_WIDTH))-1:0] c_bias_i;
wire mode_i;
...
matmul_calc_module #(8,16) U_0(
   ...
   .enable_w_o   (enable_w_o)
);

matmul_calc_module_tester #(8,16) U_1(
   .clk_i        (clk_i),
   .rst_ni       (rst_ni),
   .n_dim_i      (n_dim_i),
   .k_dim_i      (k_dim_i),
...
endmodule // matmul_calc_module_tb
